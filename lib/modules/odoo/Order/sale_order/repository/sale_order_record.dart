...
class SaleOrderRecord extends Equatable implements OdooRecord {
  ...
  static SaleOrderRecord fromJson(Map<String, dynamic> json) {
    return SaleOrderRecord(
      ...
      amount_discount: json['amount_discount'] == false ? 0.0 : json['amount_discount'],
      ...
      discount_type:
          json['discount_type'] == false ? 'percent' : json['discount_type'],
      discount_rate:
          json['discount_rate'] == false ? 0.0 : json['discount_rate'],
    );
  }
