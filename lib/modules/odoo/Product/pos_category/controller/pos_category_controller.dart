...
class PosCategoryController extends GetxController {
  ...
  RxList<AllDataCharts> dataPosCategory = <AllDataCharts>[].obs;
  RxList<AllDataCharts> dataPosCategoryView = <AllDataCharts>[].obs;
  Rx<int?> columnindex = null.obs;
  Rx<bool> ascending = false.obs;
  ...
  Future onInit() async {
    ...
    categories.clear();
    categories.value =
        mainController.env.of<PosCategoryRepository>().latestRecords.toList();
    categoryFilters.clear();
