...
class OdooKvHive implements OdooKv {
  ...
  Future<void> init() async {
    ...
    Hive.registerAdapter(ResCountryAdapter());
    Hive.registerAdapter(ResCountryStateAdapter());
    ...
    Hive.registerAdapter(TableVirtualMany2oneAdapter());
    ...
    Hive.registerAdapter(ProductPricelistAdapter());
    ...
    Hive.registerAdapter(AccountJournalAdapter());
...
class ResCountryAdapter extends TypeAdapter<ResCountryRecord> {
  @override
  final typeId = 8;

  @override
  ResCountryRecord read(BinaryReader reader) {
    return ResCountryRecord.fromJson(
        Map<String, dynamic>.from(reader.read()));
  }

  @override
  void write(BinaryWriter writer, ResCountryRecord obj) {
    writer.write(obj.toJson());
  }
}

class ResCountryStateAdapter extends TypeAdapter<ResCountryStateRecord> {
  @override
  final typeId = 9;

  @override
  ResCountryStateRecord read(BinaryReader reader) {
    return ResCountryStateRecord.fromJson(
        Map<String, dynamic>.from(reader.read()));
  }

  @override
  void write(BinaryWriter writer, ResCountryStateRecord obj) {
    writer.write(obj.toJson());
  }
}
...
class ResPartnerAdapter extends TypeAdapter<ResPartnerRecord> {
  ...
  ResPartnerRecord read(BinaryReader reader) {
    return ResPartnerRecord.fromJson(
        Map<String, dynamic>.from(reader.read()));
  }
...
class TableVirtualMany2oneAdapter extends TypeAdapter<TableVirtualMany2oneRecord> {
  @override
  final typeId = 13;

  @override
  TableVirtualMany2oneRecord read(BinaryReader reader) {
    return TableVirtualMany2oneRecord.fromJson(
        Map<String, dynamic>.from(reader.read()));
  }

  @override
  void write(BinaryWriter writer, TableVirtualMany2oneRecord obj) {
    writer.write(obj.toJson());
  }
}
...
class PosCategoryAdapter extends TypeAdapter<PosCategoryRecord> {
  ...
  PosCategoryRecord read(BinaryReader reader) {
    return PosCategoryRecord.fromJson(
        Map<String, dynamic>.from(reader.read()));
  }
...
class ProductPricelistAdapter extends TypeAdapter<ProductPricelistRecord> {
  @override
  final typeId = 17;

  @override
  ProductPricelistRecord read(BinaryReader reader) {
    return ProductPricelistRecord.fromJson(
        Map<String, dynamic>.from(reader.read()));
  }

  @override
  void write(BinaryWriter writer, ProductPricelistRecord obj) {
    writer.write(obj.toJson());
  }
}
...
class StockMoveAdapter extends TypeAdapter<StockMoveRecord> {
  ...
  StockMoveRecord read(BinaryReader reader) {
    return StockMoveRecord.fromJson(
        Map<String, dynamic>.from(reader.read()));
  }
...
class SaleOrderAdapter extends TypeAdapter<SaleOrderRecord> {
  ...
  SaleOrderRecord read(BinaryReader reader) {
    return SaleOrderRecord.fromJson(
        Map<String, dynamic>.from(reader.read()));
  }
...
class AccountJournalAdapter extends TypeAdapter<AccountJournalRecord> {
  @override
  final typeId = 22;

  @override
  AccountJournalRecord read(BinaryReader reader) {
    return AccountJournalRecord.fromJson(
        Map<String, dynamic>.from(reader.read()));
  }

  @override
  void write(BinaryWriter writer, AccountJournalRecord obj) {
    writer.write(obj.toJson());
  }
}